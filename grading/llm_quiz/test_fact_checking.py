...
def test_fact_checking():
    ...
    test_questions = [
        ...
        QuizQuestion(question="What is 2 + 2?", answer="4", number=3),  # Correct answer
    ]
    ...
    results_no_check = challenge_no_check.run_quiz_challenge(
        test_questions, "No Fact-Checking Test"
    )
